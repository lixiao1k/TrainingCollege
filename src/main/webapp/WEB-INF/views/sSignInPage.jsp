    ...
    <div class="row clearfix" style="margin-top: 100pt">
        ...
        <div class="col-md-4">
            <div class="jumbotron">
                ...
                <form class="form-horizontal" role="form" style="padding-top: 20pt" action="/sSignIn" method="post">
                ...
                <a href="/sSignUpPage" class="btn btn-sm" role="button" style="margin-left: 150pt">注册</a>
            </div>
        </div>
    </div>
</div>

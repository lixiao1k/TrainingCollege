                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <dl class="dl-horizontal">
                            <dt>订单号</dt>
                            <dd>${orderVO.orderId}</dd>
                            <dt>课程开始时间</dt>
                            <dd>${orderVO.courseBeginTime}</dd>
                            <dt>付款时间</dt>
                            <dd>${orderVO.payedTime}</dd>
                            <dt>付款金额</dt>
                            <dd>${orderVO.payment}</dd>
                            <dt>预计退款金额</dt>
                            <dd>${orderVO.amountReturned}</dd>
                        </dl>
                        <div class="box-footer">
                            <a href="/sUnsubscribeCancel" class="btn btn-default">取消</a>
                            <a href="/sUnscubscribeEnsure/${orderVO.orderId}" class="btn btn-info pull-right">确定退课</a>
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
